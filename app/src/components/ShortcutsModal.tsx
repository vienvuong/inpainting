    ...
    <Modal onClose={onClose} className="h-full sm:h-auto p-0 sm:p-0">
      <div className="h-full sm:h-auto flex flex-col sm:flex-row">
        <div className="flex sm:p-14 flex flex-col justify-center space-y-6">
          <ShortCut content="Add to mask">
            <p>LMB</p>
          </ShortCut>
          <ShortCut content="Erase from mask">
            <p>RMB</p>
          </ShortCut>
          <ShortCut content="Increase/Decrease Brush Size">
            <p>Scroll</p>
          </ShortCut>
          <ShortCut content="Pan">
            <p>Cmd/Ctrl + LMB</p>
          </ShortCut>
          <ShortCut content="Zoom">
            <p>Cmd/Ctrl + Scroll</p>
          </ShortCut>
          <ShortCut content="Undo">
            <p>Cmd/Ctrl + Z</p>
          </ShortCut>
          <ShortCut content="Redo">
            <p>Cmd/Ctrl + Shift + Z</p>
          </ShortCut>
          <ShortCut content="Run inpainting">
            <p>Enter</p>
          </ShortCut>
