...
function App() {
  ...
  return (
    <div className="h-full full-visible-h-safari flex flex-col">
      <header className="absolute z-10 flex w-full p-1 justify-center sm:justify-between items-stretch bg-white backdrop-blur backdrop-filter bg-opacity-30">
        {file ? (
          <Button
            icon={<FaArrowLeft className="w-6 h-6 p-1" />}
            onClick={() => {
              setFile(undefined)
            }}
          >
        ...
        {file ? (
          <div>
            ...
            {/* <Button
              //   onClick={}
              icon={<BsInfoLg className="w-7 h-7 p-1" />}
            />
            <Button
              //   onClick={}
              icon={<FaBars className="w-7 h-7 p-1" />}
            /> */}
          </div>
        ) : null}
      </header>
      ...
      >
        {file ? (
          ...
          <>
            ...
            >
              <div className="max-w-xl flex flex-col items-center p-0 m-0 space-y-5">
                <h1 className="text-center text-xl sm:text-3xl">
                  Image inpainting powered by <br /> 🦙
                  <u>
